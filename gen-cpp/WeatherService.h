...
class WeatherServiceIfSingletonFactory : virtual public WeatherServiceIfFactory {
 public:
  WeatherServiceIfSingletonFactory(const boost::shared_ptr<WeatherServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<WeatherServiceIf> iface_;
};
...
class WeatherServiceClient : virtual public WeatherServiceIf {
 public:
  WeatherServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    piprot_(prot),
    poprot_(prot) {
    iprot_ = prot.get();
    oprot_ = prot.get();
  }
  WeatherServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :
    piprot_(iprot),
    poprot_(oprot) {
    iprot_ = iprot.get();
    oprot_ = oprot.get();
...
class WeatherServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  WeatherServiceProcessor(boost::shared_ptr<WeatherServiceIf> iface) :
    iface_(iface) {
...
class WeatherServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  WeatherServiceProcessorFactory(const ::boost::shared_ptr< WeatherServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< WeatherServiceIfFactory > handlerFactory_;
};

class WeatherServiceMultiface : virtual public WeatherServiceIf {
 public:
  WeatherServiceMultiface(std::vector<boost::shared_ptr<WeatherServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~WeatherServiceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<WeatherServiceIf> > ifaces_;
  WeatherServiceMultiface() {}
  void add(boost::shared_ptr<WeatherServiceIf> iface) {

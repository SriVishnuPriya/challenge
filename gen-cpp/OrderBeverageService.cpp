...
::boost::shared_ptr< ::apache::thrift::TProcessor > OrderBeverageServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< OrderBeverageServiceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< OrderBeverageServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new OrderBeverageServiceProcessor(handler));
  return processor;
}
} // namespace

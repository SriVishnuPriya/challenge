...
class OrderBeverageServiceIfSingletonFactory : virtual public OrderBeverageServiceIfFactory {
 public:
  OrderBeverageServiceIfSingletonFactory(const boost::shared_ptr<OrderBeverageServiceIf>& iface) : iface_(iface) {}
 ...
 protected:
  boost::shared_ptr<OrderBeverageServiceIf> iface_;
};
...
class OrderBeverageServiceClient : virtual public OrderBeverageServiceIf {
 public:
  OrderBeverageServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> prot) :
    piprot_(prot),
    poprot_(prot) {
    iprot_ = prot.get();
    oprot_ = prot.get();
  }
  OrderBeverageServiceClient(boost::shared_ptr< ::apache::thrift::protocol::TProtocol> iprot, boost::shared_ptr< ::apache::thrift::protocol::TProtocol> oprot) :
    piprot_(iprot),
    poprot_(oprot) {
    iprot_ = iprot.get();
    oprot_ = oprot.get();
...
class OrderBeverageServiceProcessor : public ::apache::thrift::TDispatchProcessor {
 ...
 public:
  OrderBeverageServiceProcessor(boost::shared_ptr<OrderBeverageServiceIf> iface) :
    iface_(iface) {
...
class OrderBeverageServiceProcessorFactory : public ::apache::thrift::TProcessorFactory {
 public:
  OrderBeverageServiceProcessorFactory(const ::boost::shared_ptr< OrderBeverageServiceIfFactory >& handlerFactory) :
      handlerFactory_(handlerFactory) {}

  ::boost::shared_ptr< ::apache::thrift::TProcessor > getProcessor(const ::apache::thrift::TConnectionInfo& connInfo);

 protected:
  ::boost::shared_ptr< OrderBeverageServiceIfFactory > handlerFactory_;
};

class OrderBeverageServiceMultiface : virtual public OrderBeverageServiceIf {
 public:
  OrderBeverageServiceMultiface(std::vector<boost::shared_ptr<OrderBeverageServiceIf> >& ifaces) : ifaces_(ifaces) {
  }
  virtual ~OrderBeverageServiceMultiface() {}
 protected:
  std::vector<boost::shared_ptr<OrderBeverageServiceIf> > ifaces_;
  OrderBeverageServiceMultiface() {}
  void add(boost::shared_ptr<OrderBeverageServiceIf> iface) {
